...
$config['worlds'] = array(0=>"Test");
$config['groups'] = array(1=>"Player", 2=>"Tutor", 3=>"Senior Tutor", 4=>"Gamemaster", 5=>"Community Manager", 6=>"God");
