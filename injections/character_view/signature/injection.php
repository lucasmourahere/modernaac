<?PHP
	...
	echo '<input type="text" size="85" value="[IMG]http://'.$_SERVER['HTTP_HOST'].'/injections/character_view/signature/signature.php?name='.strtolower( urlencode( $player->getName( ) ) ).'[/IMG]" /><br />';
