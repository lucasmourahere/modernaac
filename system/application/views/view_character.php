...
<table width='100%'>
	...
	<tr><td width='30%'>Profession</td><td><?php echo $config['server_vocations'][$player->getVocation()]; ?></td></tr>
	...
	<tr><td width='30%'>Comment</td><td><?php echo $player->getComment(); ?></td></tr>
